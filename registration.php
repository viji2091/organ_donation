...
$blood_group = stripslashes($_REQUEST['blood_group']);
 ...
 //$phone_no = mysqli_real_escape_string($con,$phone_no);
  $trn_date = date("Y-m-d H:i:s");
      ...
      $query = "INSERT into `donor` (name,email,username, password,blood_group, organ_type, address, phone_no,trn_date)
...
$query1="INSERT into `organ_donor` (donor_id, blood_group,organ_type) VALUES ('$donor_id','$blood_group','$organ_type')";
$conn->query($query1);
echo "<div class='form'>
